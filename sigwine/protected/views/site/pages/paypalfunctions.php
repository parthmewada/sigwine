<?php
	...
	*/
	...
	'--------------------------------------------------------------------------------------------------------------------------------------------	
	*/
	function CallShortcutExpressCheckout( $paymentAmount, $currencyCodeType, $paymentType, $returnURL, $cancelURL,$desc) 
	{
		//------------------------------------------------------------------------------------------------------------------------------------
	...
	*/
	function GetShippingDetails( $token )
	{
		...
		{	
			...
			/* Commented For Recurring Payment on 19/3/2016 [Live]
	...
	*/
	...
	function CreateRecurringPaymentsProfile()
	{
		...
		$nvpstr.="&PROFILESTARTDATE=".urlencode(date("Y-m-d h:i:s"));
		$nvpstr.="&DESC=".urlencode($_SESSION["desc"]);
	...
	*/
	...
	{	
		...
		if ($SandboxFlag == true) 
			...
			$API_UserName="uday.patel-facilitator_api1.credencys.com";
                        $API_Password="V9G4A3U6RMLCKVNP";
                        $API_Signature="AeHNu56RbgBT-P5jEfI2zbA1SZYsAv-iRAKYGr0buZxvUwwv-HhZf2qm";
                        $API_Endpoint = "https://api-3t.sandbox.paypal.com/nvp";
                        $PAYPAL_URL = "https://www.sandbox.paypal.com/webscr?cmd=_express-checkout&token=";
                }
                else
                {
                        $API_UserName="mikesig_api1.hotmail.com";
                        $API_Password="GMAS48WCHJCQJVU6";
                        $API_Signature="AQU0e5vuZCvSg-XJploSa.sGUDlpAZHKuXF9EQ5adRh3z21-I4fiw3T0";
