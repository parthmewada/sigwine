...
//                        && ( $PaymentProcessorSelected == "PayPal Direct Payment"))
        ...
        $creditCardNumber                 = "4745425765192217"; //' Set this to the string entered as the credit card number on the Billing page
        $expDate                                 = "092015"; //' Set this to the credit card expiry date entered on the Billing page
        $cvv2                                         = "962"; //' Set this to the CVV2 string entered on the Billing page 
        $firstName                                 = "XYZ"; //' Set this to the customer's first name that was entered on the Billing page 
        $lastName                                 = "ABC"; //' Set this to the customer's last name that was entered on the Billing page 
        $street                                 = "TES"; //' Set this to the customer's street address that was entered on the Billing page 
        $city                                         = "ER"; //' Set this to the customer's city that was entered on the Billing page 
        $state                                         = "DE"; //' Set this to the customer's state that was entered on the Billing page 
        $zip                                         = "2255"; //' Set this to the zip code of the customer's address that was entered on the Billing page 
        $countryCode                         = "1"; //' Set this to the PayPal code for the Country of the customer's address that was entered on the Billing page 
