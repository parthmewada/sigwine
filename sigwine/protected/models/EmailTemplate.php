...
class EmailTemplate extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
                        array('template_code, email_text,description', 'required'),
                        array('template_code', 'unique'),
			array('template_code', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('template_id,description,template_code, email_text', 'safe', 'on'=>'search'),
		);
	}
